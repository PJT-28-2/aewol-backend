-- =====================================================================
-- V33: 상품당 견적 기준 티어(is_reference_tier=1) 1개 제약
--
...
--
-- ⚠️ 파일명 순연 안내: 처음 작성 시 V32였으나 develop에 이미
-- V32__add_toss_order_id_unique_constraint.sql이 있어 V33으로 밀었다. 이 브랜치의
-- V30/V31도 같은 이유로 각각 두 번 밀린 이력이 있다(그 파일 상단 참조). 파일명이
-- 달라 git 충돌은 나지 않지만 Flyway는 버전 중복으로 죽으므로, 리뷰 중 develop에
-- 새 마이그레이션이 들어오면 다시 확인해야 한다.
-- =====================================================================
